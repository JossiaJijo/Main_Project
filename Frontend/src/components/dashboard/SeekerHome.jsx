...
const SeekerHome = () => {
  return (
    <div
      style={{
        padding: "40px 20px",
        backgroundImage: "url('/Seeker_background.jpeg')", // Ensure the image path is correct
    ...
    >
      ...
      >
        ...
        >
          Discover sponsorship opportunities and connect with sponsors to bring
          your projects to life. Track submissions, manage communications, and
        ...
        >
          Make your proposals stand out by clearly articulating your goals,
          outlining your value, and demonstrating your project's potential
          impact.
        </p>
        ...
        >
          ...
          support@sponsorship.com. We're here to help you succeed!
        </p>
      </div>
    </div>
  );
